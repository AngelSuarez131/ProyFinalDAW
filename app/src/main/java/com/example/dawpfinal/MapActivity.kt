...
class MapActivity : AppCompatActivity(), OnMapReadyCallback ,
    ...
    override fun onMapReady(p0: GoogleMap) {
        mGoogleMap=p0
        val ubicacion = LatLng(-12.051885, -77.033966)
        mGoogleMap.addMarker(MarkerOptions().position(ubicacion))
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLng(ubicacion))
